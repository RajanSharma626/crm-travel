                                    ...
                                    <tbody>
                                        @forelse($rules as $rule)
                                            <tr>
                                                ...
                                                <td>{{ $rule->fixed_percentage ? $rule->fixed_percentage . '%' : 'N/A' }}
                                                </td>
                                                <td>{{ $rule->fixed_amount ? '₹' . number_format($rule->fixed_amount, 2) : 'N/A' }}
                                                </td>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-outline-primary edit-rule"
                                                        data-rule='@json($rule)'>Edit</button>
                                                    <form action="{{ route('incentive-rules.destroy', $rule->id) }}"
                ...
                <form id="ruleForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3" id="fixed_percentage_div">
                            ...
                            <input type="number" name="fixed_percentage" class="form-control" step="0.01" min="0"
                                max="100">
                        </div>
                        ...
                        <div class="mb-3" id="tiered_params_div" style="display:none;">
                            ...
                            <textarea name="params" class="form-control" rows="4"
                                placeholder='[{"min": 0, "max": 10000, "percentage": 5}, {"min": 10000, "max": 50000, "percentage": 7}]'></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="min_profit_threshold" class="form-control" step="0.01"
                                min="0" value="0">
                        </div>
                        <div class="mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#rule_type').on('change', function() {
                const type = $(this).val();
                $('#fixed_percentage_div').toggle(type === 'fixed_percentage' || type ===
                    'tiered_percentage');
