                                ...
                                <div class="card border-0 shadow-sm mt-3">
                                    <div class="card-body p-4 p-lg-5">
                                        <form action="{{ route('leads.update', $lead->id) }}" method="POST"
                                            ...
                                            <div
                                                class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between mb-4">
                                                <div>
                                                    <h4 class="fw-semibold mb-1 text-primary">Update Lead</h4>
                                                    <p class="text-muted mb-0">TSQ:
                                                        <strong>{{ $lead->tsq ?? 'N/A' }}</strong></p>
                                                </div>
                                                <span
                                                    class="badge bg-primary text-white">{{ ucfirst(str_replace('_', ' ', $lead->status)) }}</span>
                                            </div>
                                            ...
                                            <div class="border rounded-3 p-4 mb-4 bg-light">
                                                <h6 class="text-uppercase text-muted small fw-semibold mb-3">Customer
                                                    Information</h6>
                                                <div class="row g-3">
                                                    <div class="col-md-3">
                                                        <label class="form-label fw-semibold">Ref. No.</label>
                                                        <input type="text" value="{{ $lead->tsq ?? 'N/A' }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select name="salutation" class="form-select">
                                                            ...
                                                            <option value="Mr"
                                                                {{ old('salutation', $lead->salutation) == 'Mr' ? 'selected' : '' }}>
                                                                Mr</option>
                                                            <option value="Mrs"
                                                                {{ old('salutation', $lead->salutation) == 'Mrs' ? 'selected' : '' }}>
                                                                Mrs</option>
                                                            <option value="Ms"
                                                                {{ old('salutation', $lead->salutation) == 'Ms' ? 'selected' : '' }}>
                                                                Ms</option>
                                                            <option value="Dr"
                                                                {{ old('salutation', $lead->salutation) == 'Dr' ? 'selected' : '' }}>
                                                                Dr</option>
                                                            <option value="Prof"
                                                                {{ old('salutation', $lead->salutation) == 'Prof' ? 'selected' : '' }}>
                                                                Prof</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                            ...
                                            <div class="border rounded-3 p-4 mb-4">
                                                <h6 class="text-uppercase text-muted small fw-semibold mb-3">Contact
                                                    Information</h6>
                                                <div class="row g-3">
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold">Primary Number <span
                                                                class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" name="other_phone" class="form-control"
                                                            ...
                                                            value="{{ old('other_phone', $lead->other_phone) }}">
                                                    </div>
                                                    <div class="col-md-6">
                                            ...
                                            <!-- Travel Preferences -->
                                            <div class="border rounded-3 p-4 mb-4 bg-light">
                                                <h6 class="text-uppercase text-muted small fw-semibold mb-3">Travel
                                                    Preferences</h6>
                                                <div class="row g-3">
                                                    <div class="col-md-4">
                                                        ...
                                                        <select name="service_id" class="form-select">
                                                            ...
                                                            @foreach ($services as $service)
                                                                <option value="{{ $service->id }}"
                                                                    {{ (string) old('service_id', $lead->service_id) === (string) $service->id ? 'selected' : '' }}>
                                                                    {{ $service->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select name="destination_id" class="form-select">
                                                            ...
                                                            @foreach ($destinations as $destination)
                                                                <option value="{{ $destination->id }}"
                                                                    {{ (string) old('destination_id', $lead->destination_id) === (string) $destination->id ? 'selected' : '' }}>
                                                                    {{ $destination->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="date" name="travel_date" class="form-control"
                                                            value="{{ old('travel_date', $lead->travel_date ? $lead->travel_date->format('Y-m-d') : '') }}"
                                                            required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold">Return Date</label>
                                                        <input type="date" name="return_date" class="form-control"
                                                            value="{{ old('return_date', $lead->return_date ? $lead->return_date->format('Y-m-d') : '') }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold">Adults <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" name="adults"
                                                            value="{{ old('adults', $lead->adults ?? 1) }}"
                                                            min="1" class="form-control" required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold">Children (2-5 yrs)</label>
                                                        <input type="number" name="children_2_5"
                                                            value="{{ old('children_2_5', $lead->children_2_5 ?? 0) }}"
                                                            min="0" class="form-control">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold">Children (6-11 yrs)</label>
                                                        <input type="number" name="children_6_11"
                                                            value="{{ old('children_6_11', $lead->children_6_11 ?? 0) }}"
                                                            min="0" class="form-control">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold">Infants (below 2 yrs)</label>
                                                        <input type="number" name="infants"
                                                            value="{{ old('infants', $lead->infants ?? 0) }}"
                                                            min="0" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Assignment & Status -->
                                            <div class="border rounded-3 p-4 mb-4">
                                                <h6 class="text-uppercase text-muted small fw-semibold mb-3">Assignment
                                                    &amp; Status</h6>
                                                <div class="row g-3">
                                                    <div class="col-md-4">
                                                                ...
                                                                if ($lead->assigned_user_id) {
                                                                    ...
                                                                    if ($assignedEmployee) {
                                                                        ...
                                                                        if ($assignedUser && $assignedUser->user_id) {
                                                                            $currentEmployee = \App\Models\User::where(
                                                                                'user_id',
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select name="status" class="form-select" required>
                                                            <option value="new"
                                                                {{ old('status', $lead->status) == 'new' ? 'selected' : '' }}>
                                                                New</option>
                                                            <option value="contacted"
                                                                {{ old('status', $lead->status) == 'contacted' ? 'selected' : '' }}>
                                                                Contacted</option>
                                                            <option value="follow_up"
                                                                {{ old('status', $lead->status) == 'follow_up' ? 'selected' : '' }}>
                                                                Follow Up</option>
                                                            <option value="priority"
                                                                {{ old('status', $lead->status) == 'priority' ? 'selected' : '' }}>
                                                                Priority</option>
                                                            <option value="booked"
                                                                {{ old('status', $lead->status) == 'booked' ? 'selected' : '' }}>
                                                                Booked</option>
                                                            <option value="closed"
                                                                {{ old('status', $lead->status) == 'closed' ? 'selected' : '' }}>
                                                                Closed</option>
                                                            <option value="cancelled"
                                                                {{ old('status', $lead->status) == 'cancelled' ? 'selected' : '' }}>
                                                                Cancelled</option>
                                                            <option value="refunded"
                                                                {{ old('status', $lead->status) == 'refunded' ? 'selected' : '' }}>
                                                                Refunded</option>
                                                        </select>
                                                    </div>
                                                </div>
