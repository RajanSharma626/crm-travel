...
@section('content')
                            ...
                            <div class="w-100 align-items-center justify-content-between d-flex contactapp-title link-dark">
                                <div>
                                    ...
                                    <small class="text-muted">Created:
                                        {{ $lead->created_at->format('d M, Y h:i A') }}</small>
                                </div>
                                <div>
                                    <a href="{{ route('leads.index') }}" class="btn btn-outline-secondary btn-sm">Back to
                                        List</a>
                                    <a href="{{ route('leads.edit', $lead->id) }}" class="btn btn-primary btn-sm">Edit
                                        Lead</a>
                                </div>
                            </div>
                        </header>
                            ...
                            <div data-simplebar class="nicescroll-bar">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3 pb-3 border-bottom">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <i data-feather="user" class="text-primary me-2"
                                                            style="width: 16px; height: 16px;"></i>
                                                        <small class="text-muted text-uppercase fw-semibold">Customer
                                                            Details</small>
                                                    </div>
                                                    ...
                                                    <div class="d-flex flex-column gap-2">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="text-muted">{{ $lead->primary_phone ?? $lead->phone }}</span>
                                                        </div>
                                                        @if ($lead->secondary_phone)
                                                            <div class="d-flex align-items-center">
                                                                <i data-feather="phone-forwarded" class="text-muted me-2"
                                                                    style="width: 14px; height: 14px;"></i>
                                                                <span
                                                                    class="text-muted">{{ $lead->secondary_phone }}</span>
                                                            </div>
                                                        @endif
                                                        @if ($lead->other_phone)
                                                            <div class="d-flex align-items-center">
                                                                <i data-feather="phone-outgoing" class="text-muted me-2"
                                                                    style="width: 14px; height: 14px;"></i>
                                                        ...
                                                        @if ($lead->address)
                                                            <div class="d-flex align-items-start">
                                                                <i data-feather="map-pin" class="text-muted me-2 mt-1"
                                                                    style="width: 14px; height: 14px;"></i>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3 pb-3 border-bottom">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <i data-feather="briefcase" class="text-info me-2"
                                                            style="width: 16px; height: 16px;"></i>
                                                        <small class="text-muted text-uppercase fw-semibold">Travel
                                                            Details</small>
                                                    </div>
                                                    <div class="d-flex flex-column gap-2">
                                                        <div class="d-flex align-items-center">
                                                            <span class="text-muted me-2"
                                                                style="min-width: 100px;">Service:</span>
                                                            <span
                                                                class="fw-semibold">{{ $lead->service?->name ?? 'N/A' }}</span>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <span class="text-muted me-2"
                                                                style="min-width: 100px;">Destination:</span>
                                                            <span
                                                                class="fw-semibold">{{ $lead->destination?->name ?? 'N/A' }}</span>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <span class="text-muted me-2" style="min-width: 100px;">Travel
                                                                Date:</span>
                                                            <span
                                                                class="fw-semibold">{{ $lead->travel_date ? $lead->travel_date->format('d M, Y') : 'N/A' }}</span>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <span class="text-muted me-2"
                                                                style="min-width: 100px;">Travelers:</span>
                                                            <div class="d-flex gap-3">
                                                                <span class="badge bg-light text-dark">
                                                                    <i data-feather="users" class="me-1"
                                                                        style="width: 12px; height: 12px;"></i>
                                                                    Adults: {{ $lead->adults ?? 0 }}
                                                                </span>
                                                                <span class="badge bg-light text-dark">
                                                                    <i data-feather="smile" class="me-1"
                                                                        style="width: 12px; height: 12px;"></i>
                                                                    Children: {{ $lead->children ?? 0 }}
                                                                </span>
                                                                <span class="badge bg-light text-dark">
                                                                    <i data-feather="heart" class="me-1"
                                                                        style="width: 12px; height: 12px;"></i>
                                                ...
                                                <div class="mb-3 pb-3 border-bottom">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <i data-feather="user-check" class="text-success me-2"
                                                            style="width: 16px; height: 16px;"></i>
                                                        <small
                                                            class="text-muted text-uppercase fw-semibold">Assignment</small>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div>
                                                            @php
                                                                ...
                                                                $currentUserId = $currentEmployee
                                                                    ? \App\Models\User::where(
                                                                            ...
                                                                            ->orWhere(
                                                                                'email',
                                                                                $currentEmployee->login_work_email,
                                                                            )
                                                                            ->first()?->id ?? null
                                                                    : null;
                                                            @endphp
                                                            @if ($assignedEmployee && $lead->assigned_user_id == $currentUserId)
                                                                <span
                                                                    class="badge bg-success text-white fw-bold px-3 py-2">
                                                        ...
                                                        @can('edit leads')
                                                            <button class="btn btn-sm btn-outline-primary"
                                                                ...
                                                                data-bs-target="#changeAssignedUserModal">
                                                                <i data-feather="edit-2"
                                                                    style="width: 14px; height: 14px;"></i> Change
                                                            </button>
                                                        @endcan
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    <div class="d-flex align-items-center mb-2">
                                                        <i data-feather="tag" class="text-warning me-2"
                                                            style="width: 16px; height: 16px;"></i>
                                                ...
                                                <div class="col-md-8">
                                                    <form action="{{ route('leads.updateStatus', $lead->id) }}"
                                                        ...
                                                        <div class="row align-items-end g-3">
                                                            <div class="col-md-5">
                                                                <label
                                                                    class="form-label small text-muted text-uppercase fw-semibold mb-1">Change
                                                                    Status</label>
                                                                <select name="status" class="form-select" required>
                                                                    <option value="new"
                                                                        {{ $lead->status == 'new' ? 'selected' : '' }}>New
                                                                    </option>
                                                                    <option value="contacted"
                                                                        {{ $lead->status == 'contacted' ? 'selected' : '' }}>
                                                                        Contacted</option>
                                                                    <option value="follow_up"
                                                                        {{ $lead->status == 'follow_up' ? 'selected' : '' }}>
                                                                        Follow Up</option>
                                                                    <option value="priority"
                                                                        {{ $lead->status == 'priority' ? 'selected' : '' }}>
                                                                        Priority</option>
                                                                    <option value="booked"
                                                                    ...
                                                                    <option value="refunded"
                                                                        {{ $lead->status == 'refunded' ? 'selected' : '' }}>
                                                                        Refunded</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-5">
                                                                <label
                                                                    class="form-label small text-muted text-uppercase fw-semibold mb-1">Note
                                                                    (Optional)</label>
                                                            ...
                                                            <div class="col-md-2">
                                                                <button type="submit" class="btn btn-primary w-100">
                                                                    <i data-feather="check"
                                                                        style="width: 14px; height: 14px;"></i> Update
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </form>
                                ...
                                <ul class="nav nav-tabs mb-3" id="leadTabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="remarks-tab" data-bs-toggle="tab"
                                            data-bs-target="#remarks" type="button">Remarks</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="payments-tab" data-bs-toggle="tab"
                                            data-bs-target="#payments" type="button">Payments</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="costs-tab" data-bs-toggle="tab"
                                            data-bs-target="#costs" type="button">Cost Components</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="operations-tab" data-bs-toggle="tab"
                                            data-bs-target="#operations" type="button">Operations</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="documents-tab" data-bs-toggle="tab"
                                            data-bs-target="#documents" type="button">Documents</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="delivery-tab" data-bs-toggle="tab"
                                            data-bs-target="#delivery" type="button">Delivery</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="history-tab" data-bs-toggle="tab"
                                            data-bs-target="#history" type="button">History</button>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="remarks" role="tabpanel">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    @php
                                                        $nextFollow = $lead->remarks
                                                            ->filter(
                                                                fn($r) => $r->follow_up_at &&
                                                                    $r->follow_up_at->isFuture(),
                                                            )
                                                            ->sortBy('follow_up_at')
                                                            ->first();
                                                    @endphp
                                                    @if ($nextFollow)
                                                        <span class="badge bg-danger me-2">Follow-up:
                                                            {{ $nextFollow->follow_up_at->format('d M, Y h:i A') }}</span>
                                                    @endif
                                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#addRemarkModal">Add Remark</button>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <div>
                                                                    ...
                                                                    @if ($remark->follow_up_at)
                                                                        <span class="badge bg-danger ms-2">Follow-up:
                                                    ...
                                                    <tbody>
                                                        @forelse($lead->payments as $payment)
                                                            <tr>
                                                                ...
                                                                <td>{{ $payment->due_date ? $payment->due_date->format('d M, Y') : 'N/A' }}
                                                                </td>
                                                                <td><span
                                                                        class="badge bg-{{ $payment->status == 'paid' ? 'success' : ($payment->status == 'overdue' ? 'danger' : 'warning') }}">{{ ucfirst($payment->status) }}</span>
                                                                </td>
                                                                <td>
                                                                    <button
                                                                        class="btn btn-sm btn-outline-primary edit-payment"
                                                                        data-payment='@json($payment)'>Edit</button>
                                                                    <form
                                                                        action="{{ route('leads.payments.destroy', [$lead->id, $payment->id]) }}"
                                                        ...
                                                        @empty
                                                            <tr>
                                                                <td colspan="6" class="text-center">No payments
                                                                    recorded</td>
                                                            </tr>
                                                        @endforelse
                                                    </tbody>
                                    ...
                                    <div class="tab-pane fade" id="costs" role="tabpanel">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#addCostModal">Add Cost</button>
                                            </div>
                                            <div class="card-body">
                                                <table class="table table-striped">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        @forelse($lead->costComponents as $cost)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button
                                                                        class="btn btn-sm btn-outline-primary edit-cost"
                                                                        data-cost='@json($cost)'>Edit</button>
                                                                    <form
                                                                        action="{{ route('leads.cost-components.destroy', [$lead->id, $cost->id]) }}"
                                                                        method="POST" class="d-inline">
                                                                        @csrf @method('DELETE')
                                                                        <button type="submit"
                                                                            class="btn btn-sm btn-outline-danger"
                                                        ...
                                                        @empty
                                                            <tr>
                                                                <td colspan="6" class="text-center">No cost components
                                                                    recorded</td>
                                                            </tr>
                                                        @endforelse
                                                    </tbody>
                                    ...
                                    <div class="tab-pane fade" id="operations" role="tabpanel">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                @if (!$lead->operation)
                                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#addOperationModal">Create Operation</button>
                                                @endif
                                            </div>
                                            <div class="card-body">
                                                @if ($lead->operation)
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <span
                                                                        class="badge bg-primary">{{ ucfirst(str_replace('_', ' ', $lead->operation->operation_status)) }}</span>
                                                                </td>
                                                                <td>₹{{ number_format($lead->operation->nett_cost ?? 0, 2) }}
                                                                </td>
                                                                <td>
                                                                    @php
                                                                        $profit =
                                                                            ($lead->selling_price ?? 0) -
                                                                            ($lead->operation->nett_cost ?? 0);
                                                                        $profitClass =
                                                                            $profit >= 0
                                                                                ? 'text-success'
                                                                                : 'text-danger';
                                                                ...
                                                                <td>
                                                                    @if ($lead->operation->admin_approval_required)
                                                                        <span class="badge bg-warning text-dark">Approval
                                                                            Required</span>
                                                                        @if ($lead->operation->approval_reason)
                                                                            <br><small
                                                                                class="text-muted">{{ $lead->operation->approval_reason }}</small>
                                                                        @endif
                                                                    @elseif($lead->operation->approval_approved_by)
                                                                        <span class="badge bg-success">Approved</span>
                                                                    @else
                                                                        <span class="badge bg-secondary">No Approval
                                                                            Needed</span>
                                                                    @endif
                                                                </td>
                                                                ...
                                                                <td>
                                                                    @if ($lead->operation->admin_approval_required)
                                                                        @can('approve operations')
                                                                            <form
                                                                                action="{{ route('leads.operations.approve', [$lead->id, $lead->operation->id]) }}"
                                                                            ...
                                                                            <form
                                                                                action="{{ route('leads.operations.reject', [$lead->id, $lead->operation->id]) }}"
                                                                                method="POST" class="d-inline">
                                                                                @csrf
                                                                    ...
                                                                    <button class="btn btn-sm btn-outline-primary"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#editOperationModal">Edit</button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                @else
                                                    <p class="text-muted">No operation record. Create one to track nett
                                                        cost.</p>
                                                @endif
                                            </div>
                                        </div>
                                                        ...
                                                        @foreach ($defaultDocuments as $docType)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @else
                                                                        <span class="badge bg-secondary text-white">Not
                                                                            Received</span>
                                                                    @endif
                                                                </td>
                                                                ...
                                                                <td>
                                                                    @if ($document && $document->notes)
                                                                        <span
                                                                            title="{{ $document->notes }}">{{ Str::limit($document->notes, 30) }}</span>
                                                                    @else
                                                                        <span class="text-muted">-</span>
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @can('verify documents')
                                                                        @if ($document)
                                                                            <button class="btn btn-sm btn-outline-primary"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#editDocumentModal{{ $document->id }}">Update
                                                                                Status</button>
                                                                        @else
                                                                            <button class="btn btn-sm btn-outline-primary"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#createDocumentModal{{ str_replace(' ', '', $docType) }}">Mark
                                                                                Received</button>
                                                                        @endif
                                                                    @endcan
                                                                </td>
                                    ...
                                    <div class="tab-pane fade" id="delivery" role="tabpanel">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                @if (!$lead->delivery)
                                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#addDeliveryModal">Assign Delivery</button>
                                                @endif
                                            </div>
                                            <div class="card-body">
                                                @if ($lead->delivery)
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <span
                                                                        class="badge bg-primary">{{ ucfirst(str_replace('_', ' ', $lead->delivery->delivery_status ?? 'Pending')) }}</span>
                                                                </td>
                                                                <td>{{ $lead->delivery->assignedTo?->name ?? 'N/A' }}</td>
                                                                <td>{{ $lead->delivery->expected_delivery_date ? $lead->delivery->expected_delivery_date->format('d M, Y') : 'N/A' }}
                                                                </td>
                                                                <td>{{ $lead->delivery->actual_delivery_date ? $lead->delivery->actual_delivery_date->format('d M, Y') : 'N/A' }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-sm btn-outline-primary"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#editDeliveryModal">Edit</button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <div class="timeline-item mb-4 pb-3 border-bottom">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0 me-3">
                                                                    <div class="avatar avatar-rounded rounded-3 avatar-sm"
                                                                        style="background-color: #007d88;">
                                                                        <span
                                                                            class="initial-wrap text-white fw-bold">{{ strtoupper(substr($history->changedBy->name ?? 'U', 0, 1)) }}</span>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                @if ($history->from_status)
                                                                                    <span
                                                                                        class="badge bg-secondary text-white">{{ ucfirst(str_replace('_', ' ', $history->from_status)) }}</span>
                                                                                    <span class="text-muted">→</span>
                                                                                @endif
                                                                                <span
                                                                                    class="badge bg-primary text-white">{{ ucfirst(str_replace('_', ' ', $history->to_status)) }}</span>
                                                                            </div>
                                                                        </div>
                                                                        <small
                ...
                <form action="{{ route('leads.operations.store', $lead->id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">If nett cost exceeds selling price, approval will be
                                required.</small>
                        </div>
                        <div class="mb-3">
                    ...
                    <form action="{{ route('leads.documents.update', [$lead->id, $document->id]) }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="type" class="form-control" value="{{ $document->type }}"
                                    readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Status</label>
                                <select name="status" class="form-select" required>
                                    <option value="not_received"
                                        {{ $document->status == 'not_received' ? 'selected' : '' }}>Not Received</option>
                                    <option value="received" {{ $document->status == 'received' ? 'selected' : '' }}>
                                        Received</option>
                                    <option value="verified" {{ $document->status == 'verified' ? 'selected' : '' }}>
                                        Verified</option>
    ...
    @if ($lead->operation)
        <div class="modal fade" id="editOperationModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('leads.operations.update', [$lead->id, $lead->operation->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select name="operation_status" class="form-select" required>
                                    <option value="pending"
                                        {{ $lead->operation->operation_status == 'pending' ? 'selected' : '' }}>Pending
                                    </option>
                                    <option value="in_progress"
                                        {{ $lead->operation->operation_status == 'in_progress' ? 'selected' : '' }}>In
                                        Progress</option>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Nett Cost</label>
                                <input type="number" name="nett_cost" class="form-control" step="0.01"
                                    value="{{ $lead->operation->nett_cost }}">
                                <small class="text-muted">If nett cost exceeds selling price, approval will be
                                    required.</small>
                            </div>
                            <div class="mb-3">
    ...
    @if ($lead->delivery)
        <div class="modal fade" id="editDeliveryModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('leads.deliveries.update', [$lead->id, $lead->delivery->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                                ...
                                <select name="assigned_to" class="form-select" required>
                                    @foreach (\App\Models\User::where('role', 'like', '%Delivery%')->orWhere('role', 'like', '%Post Sales%')->get() as $user)
                                        <option value="{{ $user->id }}"
                                            {{ $lead->delivery->assigned_to == $user->id ? 'selected' : '' }}>
                                            {{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="delivery_status" class="form-select" required>
                                    <option value="Pending"
                                        {{ ($lead->delivery->delivery_status ?? 'Pending') == 'Pending' ? 'selected' : '' }}>
                                        Pending</option>
                                    <option value="In_Process"
                                        {{ ($lead->delivery->delivery_status ?? 'Pending') == 'In_Process' ? 'selected' : '' }}>
                                        In Process</option>
                                    <option value="Delivered"
                                        {{ ($lead->delivery->delivery_status ?? 'Pending') == 'Delivered' ? 'selected' : '' }}>
                                        Delivered</option>
                                </select>
                            </div>
                            <div class="mb-3">
                    ...
                    <form action="{{ route('leads.updateAssignedUser', $lead->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="alert alert-info">
                                <small>Current assigned user:
                                    <strong>{{ $lead->assigned_employee?->name ?? ($lead->assignedUser?->name ?? 'Unassigned') }}</strong></small>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
