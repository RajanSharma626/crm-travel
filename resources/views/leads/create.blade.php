                                        ...
                                        <form action="{{ route('leads.store') }}" method="POST" class="lead-form"
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-muted mb-0">Capture enquiry details to kick-start the
                                                        sales journey.</p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" name="first_name" class="form-control"
                                                            placeholder="e.g. Ramesh" value="{{ old('first_name') }}"
                                                            required>
                                                    </div>
                                                    <div class="col-md-3">
                                            ...
                                            <div class="border rounded-3 p-4 mb-4 bg-light">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold">Destination <span
                                                                class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select name="status" class="form-select" required>
                                                            ...
                                                            <option value="follow_up"
                                                                {{ old('status') == 'follow_up' ? 'selected' : '' }}>Follow
                                                                Up</option>
                                                            <option value="priority"
                                                                {{ old('status') == 'priority' ? 'selected' : '' }}>
                                                                Priority</option>
                                                            <option value="booked"
                                                                {{ old('status') == 'booked' ? 'selected' : '' }}>Booked
                                                            </option>
                                                            <option value="closed"
